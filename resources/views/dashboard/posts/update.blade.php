...
<div class="mb-3 lg:mb-5">
    <h1 class="text-center text-2xl font-bold mb-3 lg:text-3xl lg:mb-5 text-slate-800">Edit Post</h1>
    <hr>
</div>
<form class="max-w-3xl" method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
    ...
    <div class="mb-6">
        ...
        @if ($post->image)
        <img src="{{ asset('storage/'.$post->image) }}" class="img-preview max-h-[300px] mb-5">
        @else
    ...
    <button type="submit" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-3.5 py-2.5 text-center mr-2 mb-2">Update Post</button>
</form>
